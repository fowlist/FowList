...
<button class="printButton" value="" onClick="window.print();">Print the page</button>
...
foreach ($platoonsInForce as $key => $platoonRow) {
    ...
    foreach ($platoonSoftStatsTotal as $platoonSoftStatRow) { 
        if (( $platoonRow['code'] === $platoonSoftStatRow["code"])&&($platoonSoftStatRow["TACTICAL"]!="")) {
            ...
            <b><span class='left'>" . generateTitleImanges($insignia, $cardTitle . (($platoonRow["title"]=="")? $platoonSoftStatRow["title"] : $platoonRow["title"] ) . ($platoonRow["FormationCardTitle"]??""), (isset($platoonRow["Nation"]))?$platoonRow["Nation"]:(isset($platoonRow["platoonNation"])?$platoonRow["platoonNation"]:$query['ntn'])) ."</span><span>".$cardTitle .(($platoonRow["title"]=="")? $platoonSoftStatRow["title"] : $platoonRow["title"] )." </span></b><br>
